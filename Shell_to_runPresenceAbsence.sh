...
cat WAI321.50percent.sorted.out.gff | awk '{print $1 "\tZtRRes_"$2"\t"$3"\t"$4}' > WAI321.50percent.sorted.out.gff
...
-b /Volumes/Solomon_Lab/Megan/Spades_assembly/RRes_anno_pres_absence/WAI322.blastn.out  -g WAI322.50percent.out.gff -o WAI322.50percent.out.fasta
cat WAI322.50percent.out.gff | awk -F ZtRRes_ '{print $1 $2 }' | sort -k2 > WAI322.50percent.sorted.out.gff
cat WAI322.50percent.sorted.out.gff | awk '{print $1 "\tZtRRes_"$2"\t"$3"\t"$4}' >WAI322.50percent.sorted.out.gff
...
-b /Volumes/Solomon_Lab/Megan/Spades_assembly/RRes_anno_pres_absence/WAI323.blastn.out  -g WAI323.50percent.out.gff -o WAI323.50percent.out.fasta
cat WAI323.50percent.out.gff | awk -F ZtRRes_ '{print $1 $2 }' | sort -k2 > WAI323.50percent.sorted.out.gff
cat WAI323.50percent.sorted.out.gff | awk '{print $1 "\tZtRRes_"$2"\t"$3"\t"$4}' >WAI323.50percent.sorted.out.gff
...
-b /Volumes/Solomon_Lab/Megan/Spades_assembly/RRes_anno_pres_absence/WAI324.blastn.out  -g WAI324.50percent.out.gff -o WAI324.50percent.out.fasta
cat WAI324.50percent.out.gff | awk -F ZtRRes_ '{print $1 $2 }' | sort -k2 > WAI324.50percent.sorted.out.gff
cat WAI324.50percent.sorted.out.gff | awk '{print $1 "\tZtRRes_"$2"\t"$3"\t"$4}' >WAI324.50percent.sorted.out.gff
...
-b /Volumes/Solomon_Lab/Megan/Spades_assembly/RRes_anno_pres_absence/WAI326.blastn.out  -g WAI326.50percent.out.gff -o WAI326.50percent.out.fasta
cat WAI326.50percent.out.gff | awk -F ZtRRes_ '{print $1 $2 }' | sort -k2 > WAI326.50percent.sorted.out.gff
cat WAI326.50percent.sorted.out.gff | awk '{print $1 "\tZtRRes_"$2"\t"$3"\t"$4}' >WAI326.50percent.sorted.out.gff
...
-b /Volumes/Solomon_Lab/Megan/Spades_assembly/RRes_anno_pres_absence/WAI327.blastn.out  -g WAI327.50percent.out.gff -o WAI327.50percent.out.fasta
cat WAI327.50percent.out.gff | awk -F ZtRRes_ '{print $1 $2 }' | sort -k2 > WAI327.50percent.sorted.out.gff
cat WAI327.50percent.sorted.out.gff | awk '{print $1 "\tZtRRes_"$2"\t"$3"\t"$4}' > WAI327.50percent.sorted.out.gff
...
-b /Volumes/Solomon_Lab/Megan/Spades_assembly/RRes_anno_pres_absence/WAI328.blastn.out  -g WAI328.50percent.out.gff -o WAI328.50percent.out.fasta
cat WAI328.50percent.out.gff | awk -F ZtRRes_ '{print $1 $2 }' | sort -k2 > WAI328.50percent.sorted.out.gff
cat WAI328.50percent.sorted.out.gff | awk '{print $1 "\tZtRRes_"$2"\t"$3"\t"$4}' >WAI328.50percent.sorted.out.gff
...
cat WAI329.50percent.sorted.out.gff | awk '{print $1 "\tZtRRes_"$2"\t"$3"\t"$4}' > WAI329.50percent.sorted.out.gff
...
cat WAI332.50percent.sorted.out.gff | awk '{print $1 "\tZtRRes_"$2"\t"$3"\t"$4}' >WAI332.50percent.sorted.out.gff
...
cat WAI147.50percent.sorted.out.gff | awk '{print $1 "\tZtRRes_"$2"\t"$3"\t"$4}' > WAI147.50percent.sorted.out.gff
...
-b /Volumes/Solomon_Lab/Megan/Spades_assembly/RRes_anno_pres_absence/ST55.blastn.out  -g WAI55.50percent.out.gff -o WAI55.50percent.out.fasta
cat WAI55.50percent.out.gff | awk -F ZtRRes_ '{print $1 $2 }' | sort -k2 > WAI55.50percent.sorted.out.gff
cat WAI55.50percent.sorted.out.gff | awk '{print $1 "\tZtRRes_"$2"\t"$3"\t"$4}' > WAI55.50percent.sorted.out.gff
...
-b /Volumes/Solomon_Lab/Megan/Spades_assembly/RRes_anno_pres_absence/ST56.blastn.out  -g WAI56.50percent.out.gff -o WAI56.50percent.out.fasta
cat WAI56.50percent.out.gff | awk -F ZtRRes_ '{print $1 $2 }' | sort -k2 > WAI56.50percent.sorted.out.gff
cat WAI56.50percent.sorted.out.gff | awk '{print $1 "\tZtRRes_"$2"\t"$3"\t"$4}' > WAI56.50percent.sorted.out.gff 
